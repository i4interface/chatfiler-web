...
function TaxPayerDetail() {
  const [selectedCategory, setSelectedCategory] = useState("individualTax");
  ...
  const taxPayerData = {
    individualTax: {
      mainTitle: "Individual Tax Filing",
      mainImage: studImg,
      mainContent:
        "We understand that tax season can be stressful. Our expert team simplifies the process for you. We handle everything from preparing and filing your personal income tax return to identifying applicable deductions and credits, ensuring you maximize your refund and minimize your tax liability. Whether you're a student, employed, self-employed, or retired, we tailor our services to your specific situation.",
      keybenefits: [
        {
          title: "Student-Friendly Interface",
          description: `Our platform is designed with students in mind. Enjoy an easy-to-navigate interface that simplifies the tax filing process, making it accessible for students of all levels.
    ...
    benefits: {
      mainTitle: "Benefits and Credits",
      mainImage: worImg,
      mainContent:
        "Are you taking advantage of all the benefits and credits available to you? We can help you identify and apply for eligible programs, including the Canada Child Benefit (CCB), GST/HST credit, and other federal and provincial benefits. We'll guide you through the application process and ensure you receive the financial support you deserve.",
      keybenefits: [
        {
          title: "Worker-Focused Interface",
          description: `Our platform is tailored to meet the needs of workers. Experience an interface designed for easy navigation, ensuring a straightforward tax filing process.
    ...
    hst: {
      mainTitle: "HST Registration and Filing",
      mainImage: newcomImg,
      mainContent:
        "For businesses navigating the complexities of the Harmonized Sales Tax (HST), we offer comprehensive registration and filing services. We'll assist you with registering your business for HST, preparing and filing your HST returns accurately and on time, and ensuring compliance with all applicable regulations. Our expertise in HST will help you avoid costly errors and penalties. ",
      keybenefits: [
        {
          title: "Newcomer-Friendly Interface",
          description: `Embark on your tax-filing journey with ease through Chatfilers' Newcomer-Friendly Interface.
    ...
    taxAdvice: {
      mainTitle: "Tax Advice and Tax Planning",
      mainImage: selfImg,
      mainContent:
        "Effective tax planning is crucial for long-term financial success. We provide personalized tax advice and planning services to help you minimize your tax burden and achieve your financial goals. Our team will work with you to develop a tailored tax strategy that considers your individual circumstances and future objectives. We can assist with everything from retirement planning to investment strategies, ensuring you make informed decisions that optimize your tax position.",
      keybenefits: [
        {
          title: "Self-Employed-Focused Interface",
          description: `Our platform is designed to cater specifically to the needs of self-employed individuals. Experience an interface that streamlines the tax filing process, ensuring it meets the unique requirements of self-employment.`,
  ...
  const whyChoose = [
    {
      ...
      description:
        "Our team consists of highly qualified tax professionals with extensive knowledge of tax laws and regulations.",
    },
    {
      title: "Personalized Service",
      description:
        "We understand that every client is unique. We provide personalized service tailored to your specific needs.",
    },
    {
      title: "Accuracy and Efficiency",
      description:
        " We are committed to providing accurate and efficient tax services, minimizing errors and maximizing your financial outcomes.",
    },
    {
      title: "Timely Support",
      description:
        "We are here to answer your questions and provide support throughout the tax process.",
    },
  ];
    ...
    <Layout>
      <div className="flex justify-center items-center px-16 md:py-12 bg-white max-md:px-5">
        <div className="mt-1.5 w-full max-w-[1500px] max-md:max-w-full">
          <h1 className="text-xl md:text-5xl">Our Services </h1>
          <p>
            We offer a comprehensive range of professional tax services designed
            to meet the diverse needs of our clients. Our goal is to provide
            expert guidance and support, ensuring you navigate the complexities
            of the tax system with confidence. Here's a closer look at what we
            offer:
          </p>
          <div className="flex gap-5 max-md:flex-col items-end lg:items-center ">
            <div className="flex flex-col w-[24%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow text-base leading-7 text-gray-600 whitespace-nowrap">
                <div className="mt-16 lg:text-2xl text-xl font-medium text-zinc-900 max-md:mt-10 border-b-[1px] border-gray-300 w-full md:w-[80%]">
                  {/* Tax Payers */}
                  {/* Our Services */}
                  These are our professional services
                  <br />
                  we provided for our clients.
                </div>
                <ul className="md:hidden flex overflow-x-auto">
                  <li>
                    <div className="flex items-center justify-center mt-3 ">
                      <div
                        onClick={() => handleContentCase("individualTax")}
                        className={`justify-center items-start py-5 pr-16 pl-4 ${
                          selectedCategory === "individualTax"
                            ? "font-bold text-red-700"
                            : ""
                        }  max-md:pr-5 hover:text-red-700 cursor-pointer`}
                      >
                  ...
                  <li>
                    <div className="flex items-center justify-center mt-3   border-b-[1px] border-gray-300 w-[80%]">
                      <div
                        onClick={() => handleContentCase("benefits")}
                        className={`justify-center items-start py-5 pr-16 pl-4 ${
                  ...
                  <li>
                    <div className="flex items-center justify-center mt-3   border-b-[1px] border-gray-300 w-[80%]">
                      <div
                        onClick={() => handleContentCase("hst")}
                        className={`justify-center items-start py-5 pr-16 pl-4 ${
                          selectedCategory === "hst"
                            ? "font-bold text-red-700"
                            : ""
                        }  max-md:pr-5 hover:text-red-700 cursor-pointer`}
                      >
                  ...
                  <li>
                    <div className="flex items-center justify-center mt-3   border-b-[1px] border-gray-300 w-[80%]">
                      <div
                        onClick={() => handleContentCase("taxAdvice")}
                        className={`justify-center items-start py-5 pr-16 pl-4 ${
                          selectedCategory === "taxAdvice"
                            ? "font-bold text-red-700"
                            : ""
                        }  max-md:pr-5 hover:text-red-700 cursor-pointer`}
                      >
      ...
      <section className=" flex flex-col px-5 text-zinc-900 mt-10 md:mt-20">
        <div className="container mx-auto">
          ...
          <div
            ...
            aria-label="Benefits"
          >
            <div className="flex flex-col md:gap-5 md:my-4 xl:my-auto md:w-[40%]">
              {whyChoose.map((service, index) => (
                <div key={index} className="flex gap-5 justify-between">
                  <img
                    ...
                    alt={service.title}
                  />
                  <div className="flex-auto">{service.title}</div>
                </div>
              ))}
            </div>
            <div className="w-full overflow-hidden max-h-[200px] md:max-h-full md:w-[45%] lg:w-[30%]">
          ...
          >
            <div className="flex gap-5 justify-between text-2xl md:text-3xl leading-2 max-md:max-w-full">
              <img
                ...
                alt="ChatFiler"
              />
              <div className="flex-auto mt-2.5">{service.title}</div>
            </div>
            <div className="mt-4 md:mt-12 w-full text-base leading-6 max-md:max-w-full">
              {service.description}
            </div>
          </div>
        ))}
