...
features photo
    ...
    <div className="row justify-content-center">
      ...
      <div className="col-lg-4 col-md-6">
        <div className="testimonial-item hover-shape-border">
          ...
          <p className="desc">
          Navigating through your tax return has never been easier. Our intuitive and user-friendly platform is designed for all levels of expertise, making the tax filing process accessible to everyone.
          </p>
          <div className="testimonial-item-shape">
            <span className="border-shadow shadow-1" />
            <span className="border-shadow shadow-2" />
  ...
  <div className="testimonial-overly">
    <img src="/images/shape/overly-3.svg" alt="Shape" />
  </div>
